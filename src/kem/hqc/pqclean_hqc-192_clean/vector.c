 ...
 */
void vect_write_support_to_vector_196(uint64_t *v, uint32_t *support, uint16_t weight) {
 ...
 */
void PQCLEAN_HQC192_CLEAN_vect_generate_random_support_rejection(seedexpander_state *ctx, uint32_t *support, uint16_t weight) {
    ...
    while (i < weight) {
        do {
            if (j == random_bytes_size) {
                PQCLEAN_HQC192_CLEAN_seedexpander(ctx, rand_bytes, random_bytes_size);
                j = 0;
            }
 ...
 */
void PQCLEAN_HQC192_CLEAN_vect_generate_random_support_fisheryates(seedexpander_state *ctx, uint32_t *support, uint16_t weight) {
    uint32_t rand_u32[PARAM_OMEGA_R] = {0};

    PQCLEAN_HQC192_CLEAN_seedexpander(ctx, (uint8_t *)rand_u32, 4 * weight);
 ...
 */
int PQCLEAN_HQC192_CLEAN_vect_generate_random_support_ctus(seedexpander_state *ctx, uint32_t *support, uint16_t weight)
{
 ...
 */
int PQCLEAN_HQC192_CLEAN_vect_generate_random_support_fixed_n(seedexpander_state *ctx, uint32_t *support, uint16_t weight)
{
 ...
 * @param[in] weight Integer that is the Hamming weight
 */
void PQCLEAN_HQC192_CLEAN_vect_sample_fixed_weight_ctus(seedexpander_state *ctx, uint64_t *v, uint16_t weight)
{
    uint32_t support[PARAM_OMEGA_R] = {0};
    PQCLEAN_HQC192_CLEAN_vect_generate_random_support_ctus(ctx, support, weight);
    vect_write_support_to_vector_196(v, support, weight);
}
 ...
 * @param[in] weight Integer that is the Hamming weight
 */
void PQCLEAN_HQC192_CLEAN_vect_sample_fixed_weight_fixed_n(seedexpander_state *ctx, uint64_t *v, uint16_t weight)
{
    uint32_t support[PARAM_OMEGA_R] = {0};
    PQCLEAN_HQC192_CLEAN_vect_generate_random_support_fixed_n(ctx, support, weight);
    vect_write_support_to_vector_196(v, support, weight);
}


void PQCLEAN_HQC192_CLEAN_vect_sample_fixed_weight_rejection(seedexpander_state *ctx, uint64_t *v, uint16_t weight){
    uint32_t support[PARAM_OMEGA_R] = {0};
    PQCLEAN_HQC192_CLEAN_vect_generate_random_support_rejection(ctx, support, weight);
    vect_write_support_to_vector_196(v, support, weight);
}


void PQCLEAN_HQC192_CLEAN_vect_sample_fixed_weight_fisheryates(seedexpander_state *ctx, uint64_t *v, uint16_t weight){
    uint32_t support[PARAM_OMEGA_R] = {0};
    PQCLEAN_HQC192_CLEAN_vect_generate_random_support_fisheryates(ctx, support, weight);
    vect_write_support_to_vector_196(v, support, weight);
}
...
int PQCLEAN_HQC192_CLEAN_vect_generate_random_support_ctus_testable(seedexpander_state *ctx, uint32_t *support, uint16_t weight, float k_factor, float attempts_factor)
{
    const size_t t_over = (size_t)(k_factor * weight);
    const size_t attempts = (size_t)(t_over * attempts_factor);
...
int PQCLEAN_HQC192_CLEAN_vect_generate_random_support_fixed_n_testable(seedexpander_state *ctx, uint32_t *support, uint16_t weight, float n_iterations_factor)
{
